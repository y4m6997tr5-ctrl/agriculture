...
const farmTitleInput =
  document.getElementById("farm-title-input");
...
function loadData() {
  ...
  const savedData =
    localStorage.getItem("farm-app-data");
